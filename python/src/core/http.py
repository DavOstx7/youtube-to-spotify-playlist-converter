...
from src.core.consts import (
    MAX_REQUEST_TRIES, LOG_HTTP_RESPONSES,
    MAX_REQUEST_WAIT_TIME, INITIAL_RETRY_WAIT_TIME, WAIT_EXPONENTIAL_BASE, WAIT_JITTER
)
    ...
    def decorator(function: HttpRequestCallableT) -> CustomHttpRequestCallableT:
        ...
        @retry(
            ...
            wait=wait_exponential_jitter(
                max=MAX_REQUEST_WAIT_TIME, initial=INITIAL_RETRY_WAIT_TIME,
                exp_base=WAIT_EXPONENTIAL_BASE, jitter=WAIT_JITTER
            ),
