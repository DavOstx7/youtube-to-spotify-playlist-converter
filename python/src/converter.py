...
class PlaylistsConverter:
    ...
    async def run(self) -> List[SpotifySnapshotIdsT]:
        ...
        async for titles in self._youtube_client.walk_playlists_titles(YOUTUBE_PLAYLIST_IDS):
            add_titles_to_playlists_tasks.append(self._add_tracks_to_spotify_playlists(titles))
